  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <div className="min-h-screen flex bg-green-50 transition-all duration-700 flex-col md:flex-row">
          {/* Mobile: animation above the card */}
          <div className="flex md:hidden w-full justify-center mt-8 mb-4">
